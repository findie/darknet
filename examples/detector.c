...
void run_detector(int argc, char **argv)
{
    ...
    float video_start = find_float_arg(argc, argv, "-video-start", -1.0);
    float video_end = find_float_arg(argc, argv, "-video-end", INFINITY);
    float video_start_index = find_float_arg(argc, argv, "-video-start-index", -1.0);
    float video_end_index = find_float_arg(argc, argv, "-video-end-index", INFINITY);
    ...
    if(0==strcmp(argv[2], "test")) test_detector(datacfg, cfg, weights, filename, thresh, hier_thresh, outfile, fullscreen);
        ...
        char *name_list = option_find_str(options, "names", "data/names.list");
        char **names = get_labels(name_list);
        demo(cfg, weights, thresh, cam_index, filename, names, classes, frame_skip, prefix, avg, hier_thresh, width, height, fps, fullscreen, video_start, video_end, video_start_index, video_end_index);
    }
